...
hl.animation({ leaf = "global", enabled = true, speed = 5.5, bezier = "calm" })
hl.animation({ leaf = "workspaces", enabled = true, speed = 5.5, bezier = "calm", style = "fade" })
hl.animation({ leaf = "windows", enabled = true, speed = 5.0, bezier = "calm", style = "popin 95%" })
hl.animation({ leaf = "windowsIn", enabled = true, speed = 4.8, bezier = "calm", style = "popin 95%" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 5.2, bezier = "calm", style = "popin 95%" })
hl.animation({ leaf = "layers", enabled = true, speed = 5.0, bezier = "calm", style = "fade" })
hl.animation({ leaf = "fadeSwitch", enabled = true, speed = 6.0, bezier = "calm" })
